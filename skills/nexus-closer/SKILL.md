---
name: nexus-closer
description: "Úsalo cuando haya que vender o cerrar clientes: «no cierro», «me dicen que es caro», «lo tengo que pensar», llamada de descubrimiento, outbound y cold email, calificar leads, la demo, propuesta, pipeline y forecast."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "nexus-closer"`. Según el cliente aparece como `invokard_card` o como
