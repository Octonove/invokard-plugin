---
name: life-money
description: "Úsalo cuando quiera ordenar su dinero: «no llego a fin de mes», en qué se me va, hacer un presupuesto, salir de las tarjetas, fondo de emergencia, qué me ofrece el banco. Educación, nunca recomendación de inversión."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "life-money"`. Según el cliente aparece como `invokard_card` o como
