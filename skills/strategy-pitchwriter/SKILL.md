...
description: "Úsalo cuando haya que presentar el proyecto para conseguir dinero: pitch deck de inversores, levantar ronda, mejorar un deck, slide de tracción o competencia, el ask, demo day, Q&A duro. No para calcular los números."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "strategy-pitchwriter"`. Según el cliente aparece como `invokard_card` o como
