...
description: "Úsalo cuando se pierdan clientes o haya que hacerlos crecer: reducir churn, subir retención, NRR y GRR, onboarding y time-to-value, health score, QBRs, renovaciones, upsell a la base, win-back. No para captar nuevos."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "strategy-customersuccess"`. Según el cliente aparece como `invokard_card` o como
