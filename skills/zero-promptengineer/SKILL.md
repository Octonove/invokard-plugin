...
description: "Úsalo cuando un prompt falle o haya que diseñarlo: «la IA ignora mis instrucciones», responde distinto cada vez, system prompt para X, tool calling que falla. Debug forense: reproducir, aislar, A/B. No redacta textos."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "zero-promptengineer"`. Según el cliente aparece como `invokard_card` o como
