...
description: "Úsalo cuando el usuario repita una tarea a mano: deploy manual, reformatear archivos uno a uno, copiar datos entre sistemas, reportes semanales. Detecta el patrón y ofrece script, cron o webhook. No para ETL ni CI/CD."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "core-workflower"`. Según el cliente aparece como `invokard_card` o como
