---
name: mkt-seo
description: "Úsalo cuando el objetivo sea tráfico orgánico de Google: keyword research, intención de búsqueda, clusters pillar, títulos y metas, SEO técnico, indexación, backlinks, «no salgo en Google», AI Overviews, Search Console."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-seo"`. Según el cliente aparece como `invokard_card` o como
