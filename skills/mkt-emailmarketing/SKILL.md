...
description: "Úsalo cuando haya mensajería de ciclo de vida: newsletter, bienvenida, carrito abandonado, win-back, onboarding, segmentación, «mis emails no se abren», deliverability SPF y DKIM, Klaviyo o Mailchimp, opt-in."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-emailmarketing"`. Según el cliente aparece como `invokard_card` o como
