---
name: academy-music
description: "Úsalo cuando quiera aprender a tocar o cantar: empezar con la guitarra, tocar el piano, rutina de práctica, «no me sale la cejilla», tocar una canción entera, ukelele, bajo. Autograbación y repertorio escalonado."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "academy-music"`. Según el cliente aparece como `invokard_card` o como
