---
name: life-fixit
description: "Úsalo cuando algo se rompa en casa o haya que montar o reparar: gotea el grifo, salta el diferencial, la persiana no sube, mancha de humedad, colgar en pladur, «¿lo arreglo yo o llamo a un profesional?»."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "life-fixit"`. Según el cliente aparece como `invokard_card` o como
