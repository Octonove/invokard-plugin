---
name: dev-devops
description: "Úsalo cuando haya que desplegar u operar: subir la app a producción, CI/CD y GitHub Actions, Dockerfile, Kubernetes, Terraform, se cae el servidor, alertas, rollback, secretos, factura cloud. No para elegir stack."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "dev-devops"`. Según el cliente aparece como `invokard_card` o como
