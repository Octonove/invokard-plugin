...
description: "Úsalo cuando falte estrategia de contenido: no saber qué publicar, pilares, calendario editorial, cuánto publicar por plataforma, repurposing de una pieza en diez, auditar qué funcionó, KPIs y topic clusters."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "creator-content"`. Según el cliente aparece como `invokard_card` o como
