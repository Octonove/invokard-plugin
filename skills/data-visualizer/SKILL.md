...
description: "Úsalo cuando haya que comunicar datos visualmente: qué gráfico uso, diseñar un dashboard, arreglar un gráfico ilegible, colores para datos, accesibilidad daltónica, Looker Studio, Tableau, Power BI o D3."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "data-visualizer"`. Según el cliente aparece como `invokard_card` o como
