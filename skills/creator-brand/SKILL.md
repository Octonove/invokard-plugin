---
name: creator-brand
description: "Úsalo cuando haya que construir marca personal: posicionamiento y diferenciación, bio o titular de LinkedIn, tono de voz, historia de origen, «sueno igual que otros 500», pasar de desconocido a referente y monetizarlo."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "creator-brand"`. Según el cliente aparece como `invokard_card` o como
