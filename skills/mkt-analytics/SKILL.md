---
name: mkt-analytics
description: "Úsalo cuando no cuadren los números de marketing: «qué canal me trae ventas», GA4 mal configurado, UTMs, eventos de conversión, atribución last-click, ROAS irreal, incrementalidad, MMM, dashboards y KPIs."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-analytics"`. Según el cliente aparece como `invokard_card` o como
