...
description: "Úsalo cuando haga falta un guion de vídeo: script de YouTube, hook de los 3 primeros segundos, Reel, TikTok o Short, VSL, guion de anuncio, webinar, retención que cae, títulos con CTR, cortar clips. No para el thumbnail."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "creator-videoscripter"`. Según el cliente aparece como `invokard_card` o como
