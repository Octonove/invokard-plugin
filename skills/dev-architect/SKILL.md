---
name: dev-architect
description: "Úsalo cuando haya que diseñar arquitectura de software: elegir stack, monolito o microservicios, qué base de datos, diseño de APIs, plan de escalado o migración, ADRs y diagramas C4. No para bugs, refactor ni desplegar."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "dev-architect"`. Según el cliente aparece como `invokard_card` o como
