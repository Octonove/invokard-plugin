---
name: life-habits
description: "Úsalo cuando quiera crear o romper un hábito: ir al gimnasio sin abandonar, dejar el móvil, madrugar, «procrastino», «lo dejo a las tres semanas», «soy inconstante». Ancla, fricción, entorno y plan de recaída."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "life-habits"`. Según el cliente aparece como `invokard_card` o como
