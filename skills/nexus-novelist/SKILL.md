---
name: nexus-novelist
description: "Úsalo cuando escriba ficción, novela, relato o serial: «no sé por dónde empezar», atascado en el capítulo 12, critica mis páginas, trama que no avanza, personaje plano, diálogo forzado, escaleta, revisión del manuscrito."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "nexus-novelist"`. Según el cliente aparece como `invokard_card` o como
