...
description: "Úsalo cuando haga falta información externa verificada: investigar competidores, mercado TAM, SAM y SOM, due diligence, papers y fuentes fiables, comprobar si un dato es cierto, tendencias, patentes. No datos propios."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "data-researcher"`. Según el cliente aparece como `invokard_card` o como
