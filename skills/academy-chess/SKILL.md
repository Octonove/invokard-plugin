---
name: academy-chess
description: "Úsalo cuando quiera jugar mejor al ajedrez: subir de ELO, qué apertura juego, repertorio de blancas, analiza mis partidas, cuelgo piezas, llego al medio juego sin plan, finales, táctica diaria. No es historia."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "academy-chess"`. Según el cliente aparece como `invokard_card` o como
