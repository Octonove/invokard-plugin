...
description: "Úsalo cuando haya que publicar una web de marketing: elegir builder (Webflow, WordPress, Wix, Framer, Carrd), sitemap, maquetar una landing, dominio y hosting, migrar, publicar. No para apps con login o pagos."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-webdesigner"`. Según el cliente aparece como `invokard_card` o como
