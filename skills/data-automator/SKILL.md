---
name: data-automator
description: "Úsalo cuando haya que automatizar una tarea con IA dentro del flujo: Zapier, Make o n8n, clasificar correos sola, extraer campos de facturas o PDFs, leads al CRM sin tocar nada, LLM en un webhook, salida JSON estable."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "data-automator"`. Según el cliente aparece como `invokard_card` o como
