---
name: mkt-influencer
description: "Úsalo cuando una marca quiera contratar creadores: buscar y vetar influencers, seguidores falsos, engagement rate, cuánto pagar, seeding, brief y derechos de uso, códigos y UTMs, Spark Ads, ROI. No si eres tú el creador."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-influencer"`. Según el cliente aparece como `invokard_card` o como
