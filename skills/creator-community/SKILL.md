...
description: "Úsalo cuando haya que crear o reactivar una comunidad: abrir un Discord, Slack, Circle o grupo, nadie participa, onboarding de miembros, normas y moderación, embajadores, métricas de salud, membresía de pago."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "creator-community"`. Según el cliente aparece como `invokard_card` o como
