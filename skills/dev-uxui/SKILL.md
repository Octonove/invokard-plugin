---
name: dev-uxui
description: "Úsalo cuando haya que diseñar o pulir una interfaz: que la pantalla se vea profesional, paleta, tipografía, wireframe, design system y tokens, componentes, estados hover y error, responsive, dark mode, WCAG."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "dev-uxui"`. Según el cliente aparece como `invokard_card` o como
