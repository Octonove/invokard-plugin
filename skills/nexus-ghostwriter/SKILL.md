...
description: "Úsalo cuando haga falta un texto real escrito en SU voz: email al jefe, post de LinkedIn, propuesta, informe, discurso, renuncia, disculpa, dar una mala noticia, arreglar un borrador. No para copy de venta ni ficción."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "nexus-ghostwriter"`. Según el cliente aparece como `invokard_card` o como
