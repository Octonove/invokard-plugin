---
name: strategy-pm
description: "Úsalo cuando haya que decidir producto: priorizar el roadmap, escribir un PRD o user stories, definir el MVP, qué feature va primero, métricas y OKRs de activación, retención y north star, sprints y entrevistas."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "strategy-pm"`. Según el cliente aparece como `invokard_card` o como
