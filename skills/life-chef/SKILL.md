---
name: life-chef
description: "Úsalo cuando quiera aprender a cocinar o cocinar mejor: «se me pega el arroz», «me sale soso», qué hago con lo que hay en la nevera, cómo se hace un buen sofrito, masa madre. Una técnica por sesión y cata guiada."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "life-chef"`. Según el cliente aparece como `invokard_card` o como
