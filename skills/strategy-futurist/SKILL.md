...
description: "Úsalo cuando haya dudas sobre qué tecnología adoptar y cuándo: «¿tengo que meterme en IA?», ¿hype o real?, adoptar o esperar, radar Hold, Assess, Trial, Adopt, build o buy, piloto con kill criteria, coste de esperar."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "strategy-futurist"`. Según el cliente aparece como `invokard_card` o como
