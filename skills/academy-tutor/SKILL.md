---
name: academy-tutor
description: "Úsalo cuando el usuario quiera SER CAPAZ DE HACER algo práctico: soldar, defenderse con Excel, hacer mejores fotos, patinar, primeros auxilios. Sesiones, sub-destrezas, plan semanal y deberes. Solo si no hay academia."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "academy-tutor"`. Según el cliente aparece como `invokard_card` o como
