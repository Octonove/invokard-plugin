---
name: pro-estudio
description: "Úsalo cuando lleve su negocio de autónomo con la IA: dar de alta clientes, preparar una propuesta o un presupuesto, saber quién le debe dinero, la revisión de la semana, montar su carpeta de trabajo. No contabilidad."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "pro-estudio"`. Según el cliente aparece como `invokard_card` o como
