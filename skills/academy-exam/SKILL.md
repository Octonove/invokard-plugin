---
name: academy-exam
description: "Úsalo cuando haya fecha, temario y nota de corte: oposición, examen en 3 meses, plan de estudio, 90 temas sin tiempo, simulacros y tests, «lo leo y se me olvida», EBAU, certificación. Repaso espaciado y fallos."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "academy-exam"`. Según el cliente aparece como `invokard_card` o como
