...
description: "Úsalo cuando se busque crecer orgánicamente en redes: «no me ven en TikTok», hooks de 3 segundos, no suben los seguidores, formatos virales, algoritmo de Instagram, LinkedIn, X o Shorts, saves, shares, monetizar."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-socialhacker"`. Según el cliente aparece como `invokard_card` o como
