...
description: "Úsalo cuando haya que preparar una negociación: pedir un aumento, mejorar una oferta recibida, renegociar con un proveedor, subir tarifas, contraoferta, BATNA, ensayo de una conversación difícil. No para vender."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "nexus-negotiator"`. Según el cliente aparece como `invokard_card` o como
