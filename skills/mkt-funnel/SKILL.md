---
name: mkt-funnel
description: "Úsalo cuando haya que diseñar u optimizar el embudo completo: de lead magnet a venta, «tengo tráfico pero no convierto», CRO, conversión por etapa, upsell, retargeting, referidos, CAC y LTV. No para escribir el copy."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "mkt-funnel"`. Según el cliente aparece como `invokard_card` o como
