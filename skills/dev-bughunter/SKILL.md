---
name: dev-bughunter
description: "Úsalo cuando algo falle o haya que auditar código: errores en pantalla, stack traces, tests rojos, fugas de memoria, queries N+1, app lenta, revisión de seguridad (SQLi, XSS, IDOR, secretos). No para limpiar código sano."
---
...
1. Llama a la herramienta MCP `invokard_card` del servidor `invokard` con
   `slug: "dev-bughunter"`. Según el cliente aparece como `invokard_card` o como
